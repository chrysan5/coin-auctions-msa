...
import com.nameslowly.coinauctions.common.exception.InvalidInputMapper;
import com.nameslowly.coinauctions.common.exception.InvalidInputRes;
import com.nameslowly.coinauctions.common.response.CommonResponse;
import com.nameslowly.coinauctions.common.response.CommonResponse.CommonEmptyRes;
...
public class GlobalExceptionHandler {
    ...
    public CommonResponse<List<InvalidInputRes>> handlerValidationException(MethodArgumentNotValidException e) {
        response.setStatus(
            ResultCase.INVALID_INPUT.getHttpStatus().value()); // HttpStatus 설정
